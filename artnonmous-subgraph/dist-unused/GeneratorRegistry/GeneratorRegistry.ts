...
class Generator__getGeneratorResult {
  value0: string;
  value1: Address;
  value2: string;
  value3: Address;
...
class Generator extends SmartContract {
  static bind(address: Address, blockHash: H256): Generator {
    return new Generator("Generator", address, blockHash);
  }
